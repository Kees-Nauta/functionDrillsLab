...
let answers = bigOrSmall(bigOrSmallArray);
console.log(answers);
////////////////// PROBLEM 16 ////////////////////
let contestants = [
  "Katniss",
...
const newarr = theEliminator(contestants, loser);
console.log(newarr);
////////////////// PROBLEM 17 ////////////////////
...
const test = capitalise(sampleString);
console.log(test);
...
*/
const fakeemail = `      bossBABY@heavan.co.uk   `;
...
let testarray = upOrDown(sampleArray)
